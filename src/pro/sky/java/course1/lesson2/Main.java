...
public class Main {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Война и Мир", author1, 1932);
        ...
        book.setYearPublishing(1932);
        System.out.println("Новый год публикации: " + book.getYearPublishing());
        if (author.equals(author1)) {
            System.out.println("ООООО НЕЕЕЕТ!!!!!! Вы ввели одинаковые имена и фамилии авторов");
        }
        if (book.equals(book1)) {
            System.out.println("ООООО НЕЕЕЕТ!!!!!! Вы ввели одинаковые названия книг или года публикации");
        }
    }
}
